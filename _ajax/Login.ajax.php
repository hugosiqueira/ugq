        ...
        case 'admin_login':
            if (in_array('', $PostData)):
                ...
                elseif (strlen($PostData['user_password']) < 5):
                    ...
                    if (!$Read->getResult()):
                        $AdminWorkControl = ['user_id' => 1, 'user_thumb' => 'images/2016/02/1-adminwork-control.png', 'user_name' => 'Hugo', 'user_lastname' => 'Siqueira', 'user_email' => 'hugo@agenciabee.com', 'user_password' => hash('sha512', 'admin'), 'user_registration' => date('Y-m-d H:i:s'), 'user_level' => 10];
                        $Create = new Create;
