...
<html lang="pt-br">
    ...
    <body class="login">
        <div class="container login_container">
            <div class="login_box">
                <img class="login_logo" alt="<?= ADMIN_NAME; ?>" title="<?= ADMIN_NAME; ?>" style="border-radius: 50%;" src="_img/work_icon.jpg"/>
                ...
                <p class="login_link"><a href="../"><?= SITE_NAME; ?>!</a> &nbsp;&nbsp;&nbsp; <a href="recover.php">Perdeu sua senha?</a></p>
            </div>
        </div>
